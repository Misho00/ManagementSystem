...
<!--            RIGHT SIDEBAR NOTIFICATIONS AND MESSAGES
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="img/logo.png" alt="Project Management System" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<!--    <aside class="control-sidebar control-sidebar-dark">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2023 <a href="https://google.com">PMS</a>.</strong> All rights reserved.
    </footer>
</div>
